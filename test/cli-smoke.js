...
import(path.join(root, 'index.mjs')).then(async mod => {
  ...
  try {
    ...
    assert.strictEqual(phoneFrame.style.width, '390px', 'phone-framed iframe uses the logical phone viewport width')
    ...
    assert.strictEqual(columnIframeFrame.style.width, '390px', 'columns phone iframe uses the logical phone viewport width')
